...
function AlertDialogOverlay({ className, ...props }: React.ComponentProps<typeof AlertDialogPrimitive.Overlay>) {
    return (
        <AlertDialogPrimitive.Overlay
            ...
            className={cn(
                'data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 fixed inset-0 z-50 bg-black/80 duration-100',
                className,
            )}
            {...props}
        />
...
function AlertDialogAction({
    ...
    return (
        <AlertDialogPrimitive.Action data-slot='alert-dialog-action' className={cn(className)} asChild {...props}>
...
function AlertDialogCancel({
    ...
    Pick<React.ComponentProps<typeof Button>, 'variant' | 'size'>) {
    return (
        <AlertDialogPrimitive.Cancel data-slot='alert-dialog-cancel' className={cn(className)} asChild {...props}>
            <Button variant={variant} size={size}>
